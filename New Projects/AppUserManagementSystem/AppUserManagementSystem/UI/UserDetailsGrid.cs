        ...
        private void dataGridView1_RowHeaderMouseClick(object sender, DataGridViewCellMouseEventArgs e)
        {
            try
            {
               ...
               // this.Visible = true;
                ...
                a = frm.txtPreFlatNo.Text = dr.Cells[26].Value.ToString();
                b = frm.txtPreHouseNo.Text = dr.Cells[27].Value.ToString();
                c = frm.txtPreRoadNo.Text = dr.Cells[28].Value.ToString();
                d = frm.txtPreBlock.Text = dr.Cells[29].Value.ToString();
                x = frm.txtPreArea.Text = dr.Cells[30].Value.ToString();
                frm.txtPreLandMark.Text = dr.Cells[31].Value.ToString();
                frm.txtPreRoadName.Text = dr.Cells[32].Value.ToString();
                frm.txtPreBuildingName.Text = dr.Cells[33].Value.ToString();
                frm.PADivisionCombo.Text = dr.Cells[34].Value.ToString();
                frm.PADistrictCombo.Text = dr.Cells[35].Value.ToString();
                frm.PAThanaCombo.Text = dr.Cells[36].Value.ToString();
                frm.PAPostOfficeCombo.Text = dr.Cells[37].Value.ToString();
                y = frm.PAPostCodeText.Text = dr.Cells[38].Value.ToString();

                a1 = frm.txtPerFlatNo.Text = dr.Cells[13].Value.ToString();
                b1 = frm.txtPerHouseNo.Text = dr.Cells[14].Value.ToString();
                c1 = frm.txtPerRoadNo.Text = dr.Cells[15].Value.ToString();
                d1 = frm.txtPerBlock.Text = dr.Cells[16].Value.ToString();
                x1 = frm.txtPerArea.Text = dr.Cells[17].Value.ToString();
                frm.txtPerLandMark.Text = dr.Cells[18].Value.ToString();
                frm.txtPerRoadName.Text = dr.Cells[19].Value.ToString();
                frm.txtPerBuilding.Text = dr.Cells[20].Value.ToString();

                frm.PerADivisionCombo.Text = dr.Cells[21].Value.ToString();
                frm.PerADistrictCombo.Text = dr.Cells[22].Value.ToString();
                frm.PerAThanaCombo.Text = dr.Cells[23].Value.ToString();
                frm.PerAPostOfficeCombo.Text = dr.Cells[24].Value.ToString();
                y1 = frm.PerApostCodeText.Text = dr.Cells[25].Value.ToString();
